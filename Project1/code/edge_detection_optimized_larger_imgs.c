...
#include <string.h>
#include <stdlib.h>
#define N 372 // row dimension
#define M 496 // column dimension
#define filename "cherry_496x372_444.yuv" //use of YUV444 images
#define file_edges "cherry_496x372_edges.yuv"
...
void color(){
  ...
  for (i = N; i--;)
  {
    ...
    //determine edge direction and color accordingly
	     if (current_y[i][j] > 30){//authaireto orio,45 gia car,30 gia cat,30 gia sunflower
